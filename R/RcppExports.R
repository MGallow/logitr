...
#'
kfold <- function(n, K) {
    .Call("logitr_kfold", PACKAGE = "logitr", n, K)
}
...
#'
CV_logisticc <- function(X, y, lam = 0L, alpha = 0L, penalty = "none", 
    intercept = TRUE, method = "IRLS", tol = 1e-05, maxit = 10000, 
    vec = 0L, init = 0L, criteria = "logloss", K = 5L) {
    .Call("logitr_CV_logisticc", PACKAGE = "logitr", X, y, lam, 
...
#'
CV_linearc <- function(X, y, lam = 0L, alpha = 0L, penalty = "none", 
    weights = 0L, intercept = TRUE, kernel = FALSE, method = "SVD", 
    tol = 1e-05, maxit = 10000, vec = 0L, init = 0L, K = 5L) {
    .Call("logitr_CV_linearc", PACKAGE = "logitr", X, y, lam, 
        alpha, penalty, weights, intercept, kernel, method, 
        tol, maxit, vec, init, K)
}
...
#'
logitc <- function(u) {
    .Call("logitr_logitc", PACKAGE = "logitr", u)
}
...
#'
IRLSc <- function(X, y, lam = 0, penalty = "none", intercept = TRUE, 
    tol = 1e-05, maxit = 1e+05, vec = 0L, init = 0L) {
    .Call("logitr_IRLSc", PACKAGE = "logitr", X, y, lam, penalty, 
        intercept, tol, maxit, vec, init)
}
...
#'
linearc <- function(X, y, lam = 0, alpha = 1.5, penalty = "none", 
    weights = 0L, intercept = TRUE, kernel = FALSE, method = "SVD", 
    tol = 1e-05, maxit = 1e+05, vec = 0L, init = 0L) {
    .Call("logitr_linearc", PACKAGE = "logitr", X, y, lam, alpha, 
        penalty, weights, intercept, kernel, method, tol, maxit, 
        vec, init)
}
...
logisticc <- function(X, y, lam = 0, alpha = 1.5, penalty = "none", 
    ...
    vec = 0L, init = 0L) {
    .Call("logitr_logisticc", PACKAGE = "logitr", X, y, lam, 
        alpha, penalty, intercept, method, tol, maxit, vec, 
        init)
}
...
#'
gradient_MM_linearc <- function(betas, X, y, lam = 0, alpha = 1.5, 
    gamma = 1, weights = 0L, vec = 0L) {
    .Call("logitr_gradient_MM_linearc", PACKAGE = "logitr", 
        betas, X, y, lam, alpha, gamma, weights, vec)
}
...
MMc <- function(X, y, lam = 0, alpha = 1.5, gamma = 1, intercept = TRUE, 
    ...
    .Call("logitr_MMc", PACKAGE = "logitr", X, y, lam, alpha, 
        gamma, intercept, tol, maxit, vec, init)
}
...
#' MM_linearc(X, y)
#'
MM_linearc <- function(X, y, lam = 0, alpha = 1.5, gamma = 1, 
    weights = 0L, intercept = TRUE, tol = 1e-05, maxit = 1e+05, 
    vec = 0L, init = 0L) {
    .Call("logitr_MM_linearc", PACKAGE = "logitr", X, y, lam, 
        alpha, gamma, weights, intercept, tol, maxit, vec, init)
}
...
predict_logisticc <- function(betas, X, y = 0L) {
    .Call("logitr_predict_logisticc", PACKAGE = "logitr", betas, 
        X, y)
}
...
predict_linearc <- function(betas, X, y = 0L) {
    .Call("logitr_predict_linearc", PACKAGE = "logitr", betas, 
        X, y)
}
...
gradient_linearc <- function(betas, X, y, lam = 0, weights = 0L, 
    intercept = TRUE) {
    .Call("logitr_gradient_linearc", PACKAGE = "logitr", betas, 
...
#'
SVDc <- function(X, y, lam = 0, weights = 0L, intercept = TRUE, 
    kernel = FALSE) {
    .Call("logitr_SVDc", PACKAGE = "logitr", X, y, lam, weights, 
        intercept, kernel)
}
